...
public class LeadingAheadPage extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View leadView = inflater.inflate(R.layout.partial_page,container,false);
        RecyclerView recyclerView = leadView.findViewById(R.id.recycler);
    ...
    public static LeadingAheadPage newInstance(ArrayList<ParseHTML.GuanChaSouceData> news) {
        Bundle args = new Bundle();
        LeadingAheadPage fragment = new LeadingAheadPage();
